...
public class AlgaSecurity {
	...
	public boolean podePesquisarPedidos(Long clienteId, Long restauranteId) {
		return temEscopoLeitura() && (hasAuthority("CONSULTAR_PEDIDOS") || usuarioAutenticado(clienteId) || gerenciaRestaurante(restauranteId));
	}
	...
	public boolean podeConsultarFormasPagamentos() {
		return isAutenticado() && temEscopoLeitura();
	}
